...
| serde-json              |         | Enable an interface to automatically convert Redis types to and from JSON.                                                                                                                                                                                                          |
| serde-support           |         | Enable implementations of `Serialize` and `Deserialize` on the underlying response type for all commands.                                                                                                                                                                           |
